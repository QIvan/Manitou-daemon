...
CREATE TABLE addresses (
    addr_id integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE attachments (
    attachment_id integer PRIMARY KEY AUTOINCREMENT NOT NULL, --DEFAULT nextval('seq_attachment_id'::regclass) NOT NULL,
    mail_id integer,
...
CREATE TABLE jobs_queue (
    job_id integer PRIMARY KEY AUTOINCREMENT NOT NULL, --DEFAULT nextval('jobs_queue_job_id_seq'::regclass) NOT NULL,
    mail_id integer,
...
CREATE TABLE tags (
    tag_id integer PRIMARY KEY AUTOINCREMENT, --DEFAULT nextval('seq_tag_id'::regclass),
    name character varying(300),
    parent_id integer
);
